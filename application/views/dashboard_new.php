                                        ...
                                        <div class="padding-4">
                                            <div class="row">
                                                ...
                                                <div class="col s5 m5 right-align">
                                                    <h5 class="mb-0 white-text">Master:<?php echo $totalmastershop; ?></h5>
                                                    <p class="no-margin">Saloon:<?php echo $totalsaloonshop; ?></p>
                                                    <!--<p>6,00,00</p>-->
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="padding-4">
                                            <div class="row">
                                                ...
                                                <div class="col s5 m5 right-align">
                                                    ...
                                                    <p class="no-margin"><?php echo $clients; ?></p>
                                                    <!--<p>1,12,900</p>-->
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card gradient-45deg-amber-amber gradient-shadow min-height-100 white-text animate fadeRight">
                                        <div class="padding-4">
                                            <div class="row">
                                                ...
                                                <div class="col s5 m5 right-align">
                                                    <h5 class="mb-0 white-text">Total</h5>
                                                    <p class="no-margin"><?php echo $totalorders; ?></p>
                                                    <!--<p>3,42,230</p>-->
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card gradient-45deg-green-teal gradient-shadow min-height-100 white-text animate fadeRight">
                                        <div class="padding-4">
                                            <div class="row">
                                                ...
                                                <div class="col s5 m5 right-align">
                                                    <h5 class="mb-0 white-text">Total</h5>
                                                    <p class="no-margin"><?php echo $totalearning; ?></p>
                                                    <!--<p>$25,000</p>-->
                                                </div>
                                            </div>
                                        </div>
