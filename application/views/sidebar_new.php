 <!-- BEGIN: SideNav-->
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
        <div class="brand-sidebar">
            <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="<?php echo base_url('Welcome/dashboard'); ?>"><img class="hide-on-med-and-down " src="<?php echo base_url('assets/app-assets/images/logo/materialize-logo.png');?>" alt="materialize logo" /><img class="show-on-medium-and-down hide-on-med-and-up" src="<?php echo base_url('assets/app-assets/images/logo/materialize-logo-color.png');?>" alt="materialize logo" /><span class="logo-text hide-on-med-and-down">Saloon App</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
        </div>
...
<!--             <li class="bold"><a class="waves-effect waves-cyan " href="user-profile-page.html"><i class="material-icons">person_outline</i><span class="menu-title" data-i18n="User Profile">User Profile</span></a>
           ...
           <!--  <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">add_to_queue</i><span class="menu-title" data-i18n="Extra Components">Extra Components</span></a>
            ...
            <li class="navigation-header"><a class="navigation-header-text">Admin Dashboard </a><i class="navigation-header-icon material-icons">more_horiz</i>
            </li>
            <li class="bold"><a class="waves-effect waves-cyan" href="<?php echo base_url('Welcome/category'); ?>"><i class="material-icons">border_all</i><span class="menu-title" data-i18n="Basic Tables">Category</span></a>
            </li>
            <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url('Welcome/services'); ?>"><i class="material-icons">grid_on</i><span class="menu-title" data-i18n="Data Tables">Services</span></a>
            </li>
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">chrome_reader_mode</i><span class="menu-title" data-i18n="Forms">Master Shop</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li><a href="<?php echo base_url('Welcome/shopBookings'); ?>"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Form Elements">Appointments/Bookings</span></a>
                        </li>
                        <li><a href="<?php echo base_url('Welcome/shopOrders'); ?>"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Form Select2">Orders</span></a>
                        </li>
                    </ul>
                </div>
            </li>
             ...
             <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">chrome_reader_mode</i><span class="menu-title" data-i18n="Forms">Clients</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li><a href="<?php echo base_url('Welcome/clientDetails'); ?>"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Form Elements">Details</span></a>
                        </li>
                        <li><a href="<?php echo base_url('Welcome/clientOrders'); ?>"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Form Select2">Orders</span></a>
                        </li>
                    </ul>
                </div>
            </li>

             <li class="bold"><a class="waves-effect waves-cyan" href="<?php echo base_url('Welcome/logout'); ?>"><i class="material-icons">chrome_reader_mode</i><span class="menu-title" data-i18n="Forms">Logout</span></a>
            </li>
