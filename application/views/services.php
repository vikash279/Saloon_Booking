                      ...
                      <table class="table table-striped" id="services">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $val['service_duration'] ?></td>
                            <td><?php echo $val['service_cost'] ?></td>
                            <td><img src="<?php echo base_url('image/services/').$val['service_image'] ?>" width="50" height="60"></td>
                           <!-- <td><a href="#"  class='EditBtn btn green btn-sm'>
