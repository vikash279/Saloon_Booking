		...
		<div class="market-updates">
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-2">
					<div class="col-md-12 market-update-right">
						<i><img src="<?php echo base_url('assets/1.png');?>" width="60" height="60"></i>
					</div>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-12 market-update-right">
						<i><img src="<?php echo base_url('assets/3.png');?>" width="60" height="60"></i>
					</div>
					<div class="col-md-12 market-update-left">
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-3">
					<div class="col-md-12 market-update-right">
						<i><img src="<?php echo base_url('assets/2.png');?>" width="60" height="60"></i>
					</div>
					<div class="col-md-12 market-update-left">
						<h5>Total Orders</h5>
						<h3>12,221</h3>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-4">
					<div class="col-md-12 market-update-right">
						<i><img src="<?php echo base_url('assets/4.png');?>" width="60" height="60"></i>
					</div>
					<div class="col-md-12 market-update-left">
				...
				<div class="col-md-12 w3ls-graph">
					<!--agileinfo-grap-->
						<div class="agileinfo-grap">
							<div class="agileits-box">
								<header class="agileits-box-header clearfix">
								    <div class="col-md-10"><h3>Earning Graph Overview</h3></div>
						...
						<div class="col-md-1"></div>
							<div class="col-md-3" style="border-left:2px solid green;">
							    <h4>1,483</h4>
							    <p>Total Users</p>
							</div>
								<div class="col-md-3" style="border-left:2px solid pink;">
							    <h4>89</h4>
							    <p>New Users Today</p>
							</div>
								<div class="col-md-3" style="border-left:2px solid purple;">
							    <h4>43</h4>
							    <p>Total Orders</p>
							</div>
								<div class="col-md-2" style="border-left:2px solid blue;">
							    <h4>12,221</h4>
							    <p>Total Orders</p>
							</div>
	<!--//agileinfo-grap-->
